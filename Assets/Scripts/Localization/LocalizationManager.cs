...
namespace ARHerb.Localization
{
    ...
    {
        public static string CurrentLanguage = "pl"; // "pl", "en", "el"
        ...
        private static readonly Dictionary<string, Dictionary<string, string>> Translations = new Dictionary<string, Dictionary<string, string>>
        {
            ["pl"] = new Dictionary<string, string>
            {
                ...
                ["status_done_return"] = "📷 Powrót do skanowania (Gotowe)",
            ...
            ["el"] = new Dictionary<string, string>
            {
                ...
                ["status_analyzing"] = "Ανάλυση...",
                ["status_loading_details"] = "Φόρτωση λεπτομερειών...",
                ["status_done_return"] = "📷 Επιστροφή στη σάρωση (Έτοιμο)",
                ...
                ["edibility_unknown"] = "Άγνωστο / Χωρίς δεδομένα",
